...
import (
	...
	samplecontrollerv1alpha1 "bcnl.work/k8scontroller/api/v1alpha1"
	"bcnl.work/k8scontroller/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "fc966c88.k8s.io",
	})
	if err != nil {
	...
	if err = (&controllers.FooReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("foo-controler"),
